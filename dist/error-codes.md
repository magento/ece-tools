...
| 135 | validate-config | The search engine must be set to Elasticsearch for Magento >= 2.4.0 | Be sure that engine option does not exist in SEARCH_CONFIGURATION variable or its value is set for elasticsearch. |
