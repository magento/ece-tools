...
| 26 | validate-config | Configuration for Braintree is redundant as Braintree module not part of Magento 2.4.0 | Remove CONFIG__STORES__DEFAULT__PAYMENT__BRAINTREE__CHANNEL variable from .magento.app.yaml variables section |
...
| 133 | validate-config | Configuration for Braintree is redundant as Braintree module not part of Magento 2.4.0 | Remove CONFIG__STORES__DEFAULT__PAYMENT__BRAINTREE__CHANNEL variable from environment variables |
