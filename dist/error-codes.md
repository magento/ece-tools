...
| 135 | validate-config | The search engine must be set to Elasticsearch for Magento >= 2.4.0 | Update your configuration to use Elasticsearch as the search engine |
