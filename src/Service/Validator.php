...
class Validator
{
    ...
    public const MAGENTO_SUPPORTED_SERVICE_VERSIONS = [
        ...
        ServiceInterface::NAME_DB_MARIA => [
            ...
            '>=2.4.5-p8 <2.4.6-p11' => '>10.4 <10.6',
            '>=2.4.6-p11 <=2.4.7-p6' => '10.11',
            '>=2.4.7-p7 <2.4.8' => '>=10.6 <10.7',
        ...
        ServiceInterface::NAME_RABBITMQ => [
            ...
            '>=2.4.5-p3 <2.4.5-p13' => '~3.9.0 || ~3.11.0',
            '2.4.5-p13' => '~3.13.0 || 4.1',
            '>=2.4.5-p13 <2.4.6-p11' => '~3.12.0 || ~3.13.0',
            '2.4.6-p11' => '~3.13.0 || 4.1',
            '>=2.4.6-p11 <2.4.7-p6' => '~3.12.0 || ~3.13.0',
            '2.4.7-p6' => '~3.13.0 || 4.1',
            '>=2.4.7-p7 <2.4.8' => '~3.12.0 || ~3.13.0',
            '>=2.4.8-p1 <=2.4.9-alpha1' => '4.1',
            '>=2.4.8 <2.4.9' => '>=4.0 <4.1',
        ],
