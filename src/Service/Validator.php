...
class Validator
{
    ...
    private const VALKEY_SUPPORT_VERSIONS = [
        ...
        '>=2.4.8-p5 <2.4.9-beta' => '~8.0.0 || ~8.0.1 || ~8.1.0',
        '>=2.4.9-beta' => '~8.0.0 || ~8.0.1 || ~9.0.0',
    ];
    ...
    public const MAGENTO_SUPPORTED_SERVICE_VERSIONS = [
        ServiceInterface::NAME_PHP => [
            ...
            '>=2.4.8 <2.4.9-beta' => '>=8.3 <8.5', // '~8.3.0 || ~8.4.0'
            '>=2.4.9-beta' => '>=8.4 <8.6', // '>=8.4.0 || >=8.5.0'
        ],
        ServiceInterface::NAME_DB_MARIA => [
            ...
            '>=2.4.8-p5 <2.4.9-beta1' => '>=11.4 <11.5 || >=11.8 <11.9',
            '>=2.4.9-beta1' => '>=11.8 <11.9 || >=12.2 <12.4',
        ],
        ...
        ServiceInterface::NAME_ACTIVEMQ => [
            '>=2.4.5-p17 <2.4.6 || >=2.4.6-p13 <2.4.7 || >=2.4.7-p8 <2.4.8 || >=2.4.8-p3 <2.4.9 || >=2.4.9-beta1' => '^2',
        ],
