...
class Validator
{
    ...
    private const VALKEY_SUPPORT_VERSIONS = [
        '2.4.5-p13 <2.4.5-p17' => '~8.0.0 || ~8.0.1',
        '>=2.4.5-p17 <2.4.6' => '~8.0.0 || ~8.0.1 || ~8.1.0',
        '2.4.6-p11 <2.4.6-p15' => '~8.0.0 || ~8.0.1',
        '>=2.4.6-p15 <2.4.7' => '~8.0.0 || ~8.0.1 || ~8.1.0',
        '2.4.7-p6 <2.4.7-p10' => '~8.0.0 || ~8.0.1',
        '>=2.4.7-p10 <2.4.8' => '~8.0.0 || ~8.0.1 || ~8.1.0',
        '>=2.4.8 <2.4.8-p5' => '~8.0.0 || ~8.0.1',
        '>=2.4.8-p5 <2.4.9' => '~8.0.0 || ~8.0.1 || ~8.1.0',
        '>=2.4.9' => '~8.0.0 || ~8.0.1 || ~9.0.0',
    ];
    ...
    public const MAGENTO_SUPPORTED_SERVICE_VERSIONS = [
        ServiceInterface::NAME_PHP => [
            ...
            '>=2.4.8 <2.4.9' => '>=8.3 <8.5', // '~8.3.0 || ~8.4.0'
            '>=2.4.9' => '>=8.4 <8.6', // '>=8.4.0 || >=8.5.0'
        ],
        ServiceInterface::NAME_DB_MARIA => [
            '<2.3.6-p1' => '>=10.0 <10.3',
            '>=2.3.6-p1 <2.4.0' => '>=10.0 <10.4',
            '>=2.4.0 <2.4.4-p9 || >=2.4.5 <=2.4.5-p7' => '>=10.2 <10.5',
            '>=2.4.4-p9 <2.4.4-p10 || >=2.4.5-p8 <2.4.5-p9' => '>=10.4 <10.6',
            '>=2.4.4-p10 <2.4.4-p12 || >=2.4.5-p9 <2.4.5-p11' => '>=10.5 <10.6',
            '>=2.4.4-p12 <2.4.5 || >=2.4.5-p11 <2.4.5-p12' => '>=10.5 <10.7',
            '>=2.4.5-p16 <2.4.6' => '>=10.6 <10.7 || >=10.11 <10.12',
            '>=2.4.5-p12 <2.4.5-p16 || >=2.4.6 <2.4.6-p11 || >=2.4.7 <2.4.7-p6' => '>=10.6 <10.7',
            '>=2.4.6-p11 <2.4.7 || >=2.4.7-p6 <2.4.7-p10' => '>=10.11 <10.12',
            '>=2.4.7-p10 <2.4.8' => '>=10.11 <10.12 || >=11.8 <11.9',
            '>=2.4.8 <2.4.8-p5' => '>=11.4 <11.5',
            '>=2.4.8-p5 <2.4.9' => '>=11.4 <11.5 || >=11.8 <11.9',
            '>=2.4.9' => '>=11.8 <11.9 || >=12.2 <12.4',
        ],
        ...
        ServiceInterface::NAME_OPENSEARCH => [
            ...
            '>=2.4.4-p8 <2.4.4-p13 || >=2.4.5-p6 <2.4.5-p12'  => '1.3.*',
            '>=2.4.4-p13 <2.4.5 || >=2.4.5-p12 <2.4.6-p15 || >=2.4.7 <2.4.7-p10 || >=2.4.8 <2.4.8-p2' => '^2',
            '>=2.4.6-p15 <2.4.7 || >=2.4.7-p10 <2.4.8' => '^2 || ^3',
            '>=2.4.8-p2' => '^3',
        ],
        ServiceInterface::NAME_ACTIVEMQ => [
            '>=2.4.5-p17 <2.4.6 || >=2.4.6-p13 <2.4.7 || >=2.4.7-p8 <2.4.8 || >=2.4.8-p3 <2.4.9'
                . ' || >=2.4.9' => '^2',
        ],
        ServiceInterface::NAME_RABBITMQ => [
            ...
            '>=2.4.5-p13 <2.4.5-p17 || >=2.4.6-p11 <2.4.6-p15 || >=2.4.7-p6 <2.4.7-p10 || >=2.4.8 <2.4.8-p5'
                => '3.13 || 4.1 || 4.2',
            '>=2.4.5-p17 <2.4.6 || >=2.4.6-p15 <2.4.7 || >=2.4.7-p10 <2.4.8' => '3.13 || 4.1 || 4.2 || 4.3',
            '>=2.4.8-p5 <2.4.9' => '>4.0 <=4.3',
            '>=2.4.9' => '4.1 || 4.2 || 4.3',
        ],
