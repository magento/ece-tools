...
class Validator
{
    ...
    public const MAGENTO_SUPPORTED_SERVICE_VERSIONS = [
        ...
        ServiceInterface::NAME_DB_MARIA => [
            ...
            '>=2.4.4-p10 <2.4.4-p12 || >=2.4.5-p9 <2.4.5-p11' => '>10.4 <10.6',
            '>=2.4.4-p12 <2.4.5 || >=2.4.5-p11 <2.4.5-p12' => '>=10.5 <10.7',
            '>=2.4.5-p12 <2.4.5-p16 || >=2.4.7 <2.4.7-p6' => '>=10.6 <10.7',
            '>=2.4.5-p16 <2.4.6' => '>=10.6 <10.7 || 10.11',
            '>=2.4.6 <2.4.6-p11' => '>=10.6 <10.7',
            '>=2.4.6-p11 <2.4.7 || >=2.4.7-p6 <2.4.7-p10' => '10.11',
            '>=2.4.7-p10 <2.4.8' => '10.11 || >=11.8 <11.9',
            '>=2.4.8 <2.4.8-p5' => '>=11.4 <11.5 || >=11.8 <11.9',
        ...
        ServiceInterface::NAME_OPENSEARCH => [
            ...
            '>=2.4.6-p15 <2.4.7 || >=2.4.7-p10 <2.4.8' => '^2 || ~3.5.0',
            '>=2.4.8-p2 <2.4.8-p5'  => '^3',
            '>=2.4.8-p5' => '~3.5.0',
        ],
        ServiceInterface::NAME_ACTIVEMQ => [
            '>=2.4.5-p17 <2.4.6 || >=2.4.6-p13 <2.4.7 || >=2.4.7-p8 <2.4.8 || >=2.4.8-p3 <2.4.9 || >=2.4.9' => '^2',
        ],
