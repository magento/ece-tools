...
class Validator
{
    ...
    const MAGENTO_SUPPORTED_SERVICE_VERSIONS = [
        ServiceInterface::NAME_PHP => [
            ...
            '>=2.2.5 <2.2.10' => '>=7.0.13 <7.2', //'~7.0.13|~7.1.0',
            '>=2.2.10 <2.3.0' => '>=7.0.13 <7.3', //'~7.0.13|~7.1.0|~7.2.0',
            '>=2.3.0 <2.3.3' => '>=7.1.3 <7.3',   //'~7.1.3 || ~7.2.0',
            '>=2.3.3' => '>=7.1.3 <7.4',       //  '~7.1.3||~7.2.0||~7.3.0'
        ],
     ...
     */
    const MAGENTO_DEPRECATED_SERVICE_VERSIONS = [
        ServiceInterface::NAME_PHP => [
            '>=2.2.10 <2.3.0' => '^7.0'
        ],
    ];
