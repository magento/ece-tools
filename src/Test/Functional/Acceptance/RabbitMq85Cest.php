...
/**
 * Checks RabbitMQ configuration for PHP 8.5 and Magento 2.4.9
 *
 * @group php85
 */
class RabbitMq85Cest extends RabbitMqCest
{
    ...
    {
        return [
            'rabbitmq42-default-config-php85' => [
                'version' => '2.4.9',
                'rabbitMqVersion' => '4.2',
            ...
            'rabbitmq43-default-config-php85' => [
                'version' => '2.4.9',
                'rabbitMqVersion' => '4.3',
                'expectedHost' => 'rabbitmq',
                'expectedPort' => 5672,
