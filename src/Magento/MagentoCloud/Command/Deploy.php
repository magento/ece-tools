...
class Deploy extends Command
{
    ...
    private function sendPasswordResetEmail()
    {
        ...
        mail($this->adminEmail, "Magento Commerce Cloud - Admin URL", "Your Magento Admin username is {$this->adminUsername} .  Your Magento Admin URL is: {$adminurl} .  Please open that URL and click on \"Forgot your password\".  You will need to enter your email address which is {$this->adminEmail} . \nFor more information, please read http://devdocs.magento.com/guides/v2.2/cloud/onboarding/onboarding-tasks.html .");
    }
}
