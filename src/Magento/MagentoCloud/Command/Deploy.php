 ...
 */
private
function updateSolrConfiguration()
{
...
function isMasterBranch()
{
    if (is_null($this->isMasterBranch)) {
        if (
            isset($_ENV["MAGENTO_CLOUD_ENVIRONMENT"])
...
private
function generateFreshStaticContent()
{
...
private
function getRedisCacheConfiguration()
{
    return [
        'frontend' => [
            'default' => [
