...
class Error
{
    ...
    public const DEPLOY_ELASTIC_SUITE_WITHOUT_ES = 109;
    public const DEPLOY_ELASTIC_SUITE_WRONG_ENGINE = 110;
    public const DEPLOY_QUERY_EXECUTION_FAILED = 111;
    public const DEPLOY_INSTALL_COMMAND_FAILED = 112;
    public const DEPLOY_CONFIG_IMPORT_COMMAND_FAILED = 113;
    ...
    public const DEPLOY_VIEW_PREPROCESSED_CLEAN_FAILED = 120;
    public const DEPLOY_FILE_CREDENTIALS_EMAIL_NOT_WRITABLE = 121;
    public const DEPLOY_UPGRADE_COMMAND_FAILED = 122;
    public const DEPLOY_CACHE_FLUSH_COMMAND_FAILED = 123;
    public const DEPLOY_MAINTENANCE_MODE_DISABLING_FAILED = 124;
    ...
    public const PD_CACHE_FLUSH_COMMAND_FAILED = 223;
