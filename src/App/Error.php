...
class Error
{
    ...
    public const WARN_WRONG_SPLIT_DB_CONFIG = 2001;
    public const WARN_DIR_NESTING_LEVEL_NOT_CONFIGURED = 2002;
    public const WARN_NOT_CORRECT_LOCAL_XML_FILE = 2003;
    public const WARN_ADMIN_DATA_IGNORED = 2004;
    public const WARN_ADMIN_EMAIL_NOT_SET = 2005;
    public const WARN_UPDATE_PHP_VERSION = 2006;
    public const WARN_SOLR_DEPRECATED = 2007;
    public const WARN_SOLR_NOT_SUPPORTED = 2008;
    public const WARN_ES_INSTALLED_BUT_NOT_USED = 2009;
    public const WARN_ES_VERSION_MISMATCH = 2010;
    public const WARN_CONFIG_NOT_COMPATIBLE = 2011;
    public const WARN_DEPLOY_SCD_OPTIONS_IGNORANCE = 2012;
    public const WARN_DEPRECATED_VARIABLES = 2013;
    public const WARN_ENVIRONMENT_CONFIG_NOT_VALID = 2014;
    public const WARN_CONFIG_WRONG_JSON_FORMAT = 2015;
    public const WARN_SERVICE_VERSION_NOT_COMPATIBLE = 2016;
    public const WARN_SERVICE_PASSED_EOL = 2017;
    public const WARN_DEPRECATED_MYSQL_SEARCH_ENGINE = 2018;
